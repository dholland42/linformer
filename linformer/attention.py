...
class LinearMultiHeadAttention(Layer):
  """LinearMultiHeadAttention layer.
  ...
  When using LinearMultiHeadAttention inside a custom Layer, the custom Layer must
  implement `build()` and call LinearMultiHeadAttention's `_build_from_signature()`.
  ...
  >>> layer = LinearMultiHeadAttention(num_heads=2, key_dim=2)
  ...
  >>> layer = LinearMultiHeadAttention(num_heads=2, key_dim=2, attention_axes=(2, 3))
  ...
  def get_config(self):
    ...
    base_config = super(LinearMultiHeadAttention, self).get_config()
  ...
  def call(self,
    ...
    k_transformed = self._kt(key)
    v_transformed = self._vt(value)

    attention_output, attention_scores = self._compute_attention(
        query, k_transformed, v_transformed, attention_mask, training)
